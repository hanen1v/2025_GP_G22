...
import 'AIConsultationPage.dart';
...
class AIPage extends StatelessWidget {
  ...
  Navigator.pushNamed(
    ...
    arguments: RequestType.consultation,
                    ...
                    const Text(
                      "احصل على مساعدة الذكاء الاصطناعي في اختيار انسب محامي حسب تفاصيل استشارتك وتفضيلاتك!",
                      textAlign: TextAlign.center,
                      style: TextStyle(
                        fontSize: 14,
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
  Navigator.pushNamed(context, '/ai_contract_drafting');
},
                        style: ElevatedButton.styleFrom(
                          backgroundColor: mainColor,
                          padding: const EdgeInsets.symmetric(vertical: 16),
                    ...
                    const SizedBox(height: 20),
                    const Text(
                      "احصل على مساعدة الذكاء الاصطناعي لصياغة عقد!",
                      textAlign: TextAlign.center,
                      style: TextStyle(
                        fontSize: 14,
                        color: Colors.black87,
      ...
      bottomNavigationBar: const AppBottomNav(currentRoute: "/ai_contract_drafting"),
