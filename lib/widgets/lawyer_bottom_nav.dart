        ...
        child: SafeArea(
          ...
          child: SizedBox(
            ...
            child: Row(
              ...
              children: [
                _navItem(context, Iconsax.note_2, 'الطلبات', '/lawyer/requests'),
                _navItem(context, Iconsax.video_time, 'الإتاحة', '/lawyer/availability'),
                _navItem(context, Iconsax.more, 'المزيد', '/lawyer/more'),
              ],
            ),
          ),
        ),
