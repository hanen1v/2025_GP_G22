...
--
-- Host: localhost:8889
-- Generation Time: 03 نوفمبر 2025 الساعة 09:43
-- إصدار الخادم: 5.7.24
-- PHP Version: 8.3.1
...
(1, 'hanenLaw', 'حنين الفصيلي', '0551112233', 'Hanen@123', 'L-2025-001', 6, 'Female', 'القانون التجاري', 'العقود', 'التحكيم التجاري', 'license_hanen.pdf', 'بكالوريوس قانون', 'القانون العام', 'lawyer1.jpg', 'Approved', 5, '200.00'),
(2, 'munirahLaw', 'منيره السليم', '0552223344', 'Munirah@123', 'L-2025-002', 4, 'Female', 'القانون المدني', 'الأحوال الشخصية', 'القضايا العقارية', 'license_munirah.pdf', 'بكالوريوس قانون', 'القانون الخاص', 'lawyer1.jpg', 'Approved', 5, '350.00'),
(3, 'lamaLaw', 'لمى الخثلان', '0553334455', 'Lama@123', 'L-2025-003', 5, 'Female', 'القانون الجنائي', 'الجرائم الإلكترونية', 'القضايا العمالية', 'license_lama.pdf', 'ماجستير قانون', 'القانون الجنائي', 'lawyer1.jpg', 'Approved', 5, '100.00'),
(4, 'layanLaw', 'ليان الماضي', '0554445566', 'Layan@123', 'L-2025-004', 3, 'Female', 'القانون الإداري', 'الأنظمة الحكومية', 'العقود الإدارية', 'license_layan.pdf', 'بكالوريوس قانون', 'القانون الإداري', 'lawyer1.jpg', 'Approved', 5, '200.00'),
(5, 'khaliiid', 'khalid jamal', '0512345678', '$2y$10$.Dl4ncwqU6u3ruXraHRwZ.Cu1tybTLbqCpiuPT4TLzYmriJx05qmi', '123456', 12, 'Male', 'قضايا العمالة', 'تجاري', '', 'license_khaliiid_1761140125.pdf', 'ماجستير', 'قانون', 'lawyer1.jpg', 'Rejected', 0, '150.00'),
(6, 'manool', 'manal jamal', '0512345123', '$2y$10$r4/iZMPZ4TY4FIoLLsJXRuI9aTdVTMzWPnj9KbXAf/FwcrAGCG7ZK', '123789', 3, 'Female', 'عمل', 'تجاري', '', 'license_manool_1761165836.pdf', 'دكتوراه', 'قانون', 'lawyer1.jpg', 'Approved', 0, '250.00'),
(7, 'fahadyah', 'fahad yahya', '0564614253', '$2y$10$8TdCZyVBaVZwat3C.m4o1enWG01j1haylmDhL5RDiu1Y.9nC.Sdg.', '1166554', 4, 'Male', 'ملكية فكرية', '', '', 'license_fahadyah_1761246600.pdf', 'دكتوراه', 'قانون', 'lawyer1.jpg', 'Approved', 0, '120.00');
...
(3, 1, 5, 'license_khaliiid_1761140125.pdf', 'khalid jamal', '123456', 'Rejected', '2025-10-22 16:35:25'),
(4, 1, 6, 'license_manool_1761165836.pdf', 'manal jamal', '123789', 'Approved', '2025-10-22 23:43:56'),
...
INSERT INTO `timeslot` (`id`, `lawyer_id`, `day`, `time`) VALUES
(1, 7, 'monday', '07:00:00');
...
--
ALTER TABLE `lawyer`
  MODIFY `LawyerID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
