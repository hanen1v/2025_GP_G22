...
--
-- Host: localhost:8889
-- Generation Time: 17 نوفمبر 2025 الساعة 11:59
-- إصدار الخادم: 5.7.24
-- PHP Version: 8.3.1
...
(1, 3, 5, '2025-11-03 09:41:14', 'Active', NULL, 1),
(2, 2, 1, '2025-11-16 01:33:54', 'Upcoming', '200.00', 2),
...
(1, 1, 'monday', '07:00:00', 0),
(2, 1, 'monday', '09:00:00', 0),
(3, 1, 'wednesday', '14:00:00', 0),
(4, 1, 'thursday', '18:00:00', 0),
(5, 3, 'monday', '10:00:00', 0),
...
(14, 4, 'monday', '07:00:00', 0),
(15, 1, 'tuesday', '09:30:00', 0),
(16, 3, 'friday', '20:00:00', 0);
...
ALTER TABLE `appointment`
  ...
  ADD CONSTRAINT `appointment_ibfk_3` FOREIGN KEY (`timeslot_id`) REFERENCES `timeslot` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `request`
  ...
  ADD CONSTRAINT `request_ibfk_2` FOREIGN KEY (`LawyerID`) REFERENCES `lawyer` (`LawyerID`) ON DELETE CASCADE;

--
-- القيود للجدول `timeslot`
--
ALTER TABLE `timeslot`
  ADD CONSTRAINT `timeslot_ibfk_1` FOREIGN KEY (`lawyer_id`) REFERENCES `lawyer` (`LawyerID`) ON DELETE CASCADE;
COMMIT;
